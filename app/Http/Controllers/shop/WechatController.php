...
class WechatController extends Controller{
  function index(Request $request){
    $code = $request->code;
    if($code){
      $token_url="https://api.weixin.qq.com/sns/oauth2/access_token?appid=".config('wechat.mp.appid')."&secret=".config('wechat.mp.')."&code=CODE&grant_type=authorization_code";
